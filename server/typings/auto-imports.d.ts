...
declare global {
  ...
  const CronExpression: typeof import('@nestjs/schedule')['CronExpression']
  ...
  const IsEmail: typeof import('class-validator')['IsEmail']
  ...
  const IsPhoneNumber: typeof import('class-validator')['IsPhoneNumber']
  ...
  const ScheduleModule: typeof import('@nestjs/schedule')['ScheduleModule']
  ...
  const emailRegExp: typeof import('../src/utils/validator')['emailRegExp']
  ...
  const mobileRegExp: typeof import('../src/utils/validator')['mobileRegExp']
  const random: typeof import('../src/utils/utils')['random']
  const randomCode: typeof import('../src/utils/utils')['randomCode']
  const randomId: typeof import('../src/utils/utils')['randomId']
  const redisExpire: typeof import('../src/config/index')['redisExpire']
  ...
  const useParseToken: typeof import('../src/utils/utils')['useParseToken']
