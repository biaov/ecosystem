  ...
  <c-layout-form @ok="handleSubmit" v-if="!loading">
    <a-card title="基本信息">
      ...
      <a-form-item label="兑换积分" required>
        <a-input-number v-model:value="formState.credit" :min="0" :max="9999" :precision="0" placeholder="请输入兑换积分"
          :disabled="disabled" />
      </a-form-item>
      ...
      <a-form-item label="礼品库存" required>
        <a-input-number v-model:value="formState.stock" :min="0" :max="9999" :precision="0" placeholder="请输入礼品库存"
          :disabled="disabled" />
      </a-form-item>
